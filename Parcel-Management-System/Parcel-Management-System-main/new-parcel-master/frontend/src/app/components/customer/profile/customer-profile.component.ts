  ...
  template: `
    ...
    <div class="profile-container">
      <div class="profile-content">
        ...
        <div class="profile-info-section" *ngIf="userInfo">
          <div class="info-card">
            ...
            <div class="info-grid">
              ...
              <div class="info-item">
                ...
                <div class="info-content">
                  ...
                  <span class="info-value">{{ userInfo.customerName }}</span>
                </div>
              </div>
        ...
        <div class="stats-section">
          <div class="stats-header">
            ...
            <p>Your courier service activity overview</p>
          </div>
...
export class CustomerProfileComponent implements OnInit {
  ...
  loadUserInfo() {
    this.userInfo = this.authService.getCurrentUserByRole('CUSTOMER');
    if (!this.userInfo) {
