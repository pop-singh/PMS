          ...
          <div class="form-card">
            ...
            <form [formGroup]="trackingForm" (ngSubmit)="trackPackage()" class="tracking-form">
                <div class="form-field-container">
                  ...
                  <input type="text" formControlName="bookingId" placeholder="Enter your booking ID" class="form-input">
                  <div class="error-message" *ngIf="trackingForm.get('bookingId')?.hasError('required') && trackingForm.get('bookingId')?.touched">
      ...
      this.trackingService.trackCustomerBooking(bookingId).subscribe({
        next: (response) => {
          ...
          if (response.success) {
            ...
            alert(response.message || 'Tracking failed');
          }
        },
        error: (error) => {
          this.isLoading = false;
